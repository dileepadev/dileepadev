...
| ----------- | --------------------------------------------------------------------------------------------- |
| `main`      | The published state of the platform standards. This is what other repositories read from.     |

There is no `dev` branch in this repository. Work branches off `main` and merges back into it
