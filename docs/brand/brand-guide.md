...
emerald meaning something: if every link were green, none of them would stand out as *the* one
...
Brief: *a single continuous stroke that resolves into the `/.` terminal.* Avoid a circuit-board
